...
[`doc/why_refinements_dont_work.md`](doc/why_refinements_dont_work.md). For
a class-identity-based alternative we benchmarked and rejected, see
[`doc/spike_debug_inspector.md`](doc/spike_debug_inspector.md).
